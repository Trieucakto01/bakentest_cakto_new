...
#endif
#if ENABLE_DRIVER_DEYE_SOLARMAN
	//drvdetail:{"name":"DeyeSolarman",
	//drvdetail:"title":"Deye Solarman V5",
	//drvdetail:"descr":"Minimal Solarman V5 TCP driver for sending Modbus RTU write-register commands to Deye inverters/loggers.",
	//drvdetail:"requires":""}
	{ "DeyeSolarman",                       // Driver Name
	DeyeSolarman_Init,                      // Init
	DeyeSolarman_RunEverySecond,            // onEverySecond
	DeyeSolarman_AppendInformationToHTTPIndexPage, // appendInformationToHTTPIndexPage
	NULL,                                   // runQuickTick
	DeyeSolarman_Stop,                      // stopFunction
	NULL,                                   // onChannelChanged
	NULL,                                   // onHassDiscovery
	false,                                  // loaded
	},
